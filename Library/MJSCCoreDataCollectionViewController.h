...
/*
 ...
 - Hook a NSFetchResultsController with a UICollectionView
 
 * Needs to be subclassed. Subclasses need to:
 - Provide a set of fetched results to show (NSFetchedResultsController)
 - Hook a UICollectionView
 - Override |collectionView:cellForItemAtIndexPath:|
 - Implement |UICollectionViewDelegate| or |UICollectionViewDelegateFlowLayout|
 
 */

@interface MJSCCoreDataCollectionViewController : UIViewController<NSFetchedResultsControllerDelegate,UICollectionViewDataSource>
...
// UICollectionViewDelegate method to be overriden
